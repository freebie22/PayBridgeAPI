        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistraionNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    CEOFirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CEOLastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CEOMiddleName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonalAccountHolders", x => x.AccountId);
                    table.ForeignKey(
                        name: "FK_PersonalAccountHolders_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "CorporateAccountHolders",
                columns: table => new
                {
                    AccountId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShortCompanyName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StreetAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TypesOfActivity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ManagerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CorporateAccountHolders", x => x.AccountId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonalBankAccounts", x => x.AccountId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PersonalBankAccounts_Banks_BankId",
                        column: x => x.BankId,
                        principalTable: "Banks",
                        principalColumn: "BankId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PersonalBankAccounts_PersonalAccountHolders_AccountOwnerId",
                        column: x => x.AccountOwnerId,
                        principalTable: "PersonalAccountHolders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonalBankAccounts_AccountOwnerId",
                table: "PersonalBankAccounts",
                column: "AccountOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonalBankAccounts_BankId",
                table: "PersonalBankAccounts",
                column: "BankId");
