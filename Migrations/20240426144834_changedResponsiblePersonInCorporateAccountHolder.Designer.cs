...
namespace PayBridgeAPI.Migrations
{
    ...
    [Migration("20240426144834_changedResponsiblePersonInCorporateAccountHolder")]
    partial class changedResponsiblePersonInCorporateAccountHolder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayBridgeAPI.Models.MainModels.ChatModels.ChatLine", b =>
                {
            ...
            modelBuilder.Entity("PayBridgeAPI.Models.Transcations.CompanyToCompanyTransaction", b =>
                {
                    ...
                    b.Property<int>("ReceiverBankAssetId")
                        .HasColumnType("int");

                    b.Property<int>("SenderBankAssetId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReceiverBankAssetId");

                    b.HasIndex("SenderBankAssetId");

                    b.ToTable("CompanyToCompanyTransactions");
                });

            modelBuilder.Entity("PayBridgeAPI.Models.Transcations.CompanyToUserTransaction", b =>
                {
                    b.Property<int>("TransactionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CompanyToUserTransactions");
                });

            modelBuilder.Entity("PayBridgeAPI.Models.Transcations.UserToCompanyTransaction", b =>
                {
                    b.Property<int>("TransactionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserToCompanyTransactions");
                });
            ...
            modelBuilder.Entity("ApplicationUserChatRoom", b =>
                {
                    b.HasOne("PayBridgeAPI.Models.MainModels.ChatModels.ChatRoom", null)
                        .WithMany()
                        .HasForeignKey("ChatRoomsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayBridgeAPI.Models.User.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PayBridgeAPI.Models.MainModels.ChatModels.ChatLine", b =>
                {
                    b.HasOne("PayBridgeAPI.Models.MainModels.ChatModels.ChatRoom", "ChatRoom")
                        .WithMany("ChatLines")
            ...
            modelBuilder.Entity("PayBridgeAPI.Models.Transcations.CompanyToCompanyTransaction", b =>
                {
                    b.HasOne("PayBridgeAPI.Models.MainModels.CorporateBankAccount", "CompanyReceiver")
                        .WithMany()
                        .HasForeignKey("CompanyReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayBridgeAPI.Models.MainModels.CorporateBankAccount", "CompanySender")
                        .WithMany()
                        .HasForeignKey("CompanySenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayBridgeAPI.Models.MainModels.CompanyBankAsset", "ReceiverBankAsset")
                        .WithMany()
                        .HasForeignKey("ReceiverBankAssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayBridgeAPI.Models.MainModels.CompanyBankAsset", "SenderBankAsset")
                        .WithMany()
                        .HasForeignKey("SenderBankAssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompanyReceiver");

                    b.Navigation("CompanySender");

                    b.Navigation("ReceiverBankAsset");

                    b.Navigation("SenderBankAsset");
                });
            ...
            modelBuilder.Entity("PayBridgeAPI.Models.Transcations.CompanyToUserTransaction", b =>
                {
                    ...
                    b.HasOne("PayBridgeAPI.Models.MainModels.BankCard", "BankCard")
                        .WithMany()
